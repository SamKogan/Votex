...
<div class="row">
	<div class='col-md-3'>
		...
		<button type="button" class="btn btn-default btn-sm plus" id="more_fields" onclick="add_fields();" value="Add More"><span class="glyphicon glyphicon-plus"></span>Add Group</button>
...
<div class="row">
<hr>
<button class="btn btn-primary btn-lg disabled plus">
	Update My Policy
</button>
